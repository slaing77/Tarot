...
# Methods
Using Starry AI, text based prompts, and my own created style sets along with other curated styles I am building a tarot deck. Hundreds of iterations, variations, prompts and negative prompts later I am often left with multiple compelling images it becomes difficult to choose only one.
But choose, I must [^1].
